...
public class AllowableChildModifiers {
    public static void main(String[] args) {
        ...
        a = pug;
        System.out.println("Pug's breed is " + a.breed); //Unknown
        System.out.println("Pug's owner is " + a.owner);//Unknown
        System.out.println("Pug's name is " + a.name);//Unknown
        //System.out.println("Pug's type is " + a.type); //cannot access privat in parent Animal
    }
}